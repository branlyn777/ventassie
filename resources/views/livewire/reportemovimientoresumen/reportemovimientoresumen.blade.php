...
@endsection
   ...
   <div class="widget-content">
        ...
        <ul class="row justify-content-end">
                ...
                <a wire:click.prevent="generarpdf({{$totalesIngresosV}}, {{$totalesIngresosS}}, {{$totalesIngresosIE}}, {{$totalesEgresosV}}, {{$totalesEgresosIE}}, {{$op_sob_falt}})" class="btn btn-warning">
                    Generar PDF
                </a>
